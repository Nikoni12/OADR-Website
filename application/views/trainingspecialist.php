                ...
                <h1 class = "h1title" style = "border-bottom: 2px solid currentColor;">Careers</h1><br> 
                    <div class="row ">
                        <div class="col-md-3 sidebar" style = "">
							...
							<div id=""><b>Place of Assignment:</b>Training and Program Development Division</div>
							<div id=""><b>Position Title :</b> Training Specialist I</div>
							<div id=""><b>Plantilla Item No. :</b> TRNSP1-7-2021 TRNSP1-8-2021 TRNSP1-9-2021</div>
							<div id=""><b>Salary/Job/Pay Grade :</b> 11</div>
							<div id=""><b>Monthly Salary :</b> Php 25,439.00</div>
							<div id=""><b>Eligibility :</b> Career Service Professional</div>
							<div id=""><b>Education :</b> Bachelor`s Degree</div>
							<div id=""><b>Training :</b> None required</div>
							<div id=""><b>Work Experience :</b> 4 years of supervisory and management experience</div>
                            <div id=""><b>Competency :</b> N/A</div>
                            </div>
                        </div>
                    </div>
                </div>
