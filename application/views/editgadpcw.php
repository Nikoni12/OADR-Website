            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <form method="POST" action="<?php echo base_url();?>User/updategadpcw" enctype="multipart/form-data" class="user">
                        <input type ="hidden" name = "edit_id" value = "<?php  echo $row->ID;?>">
                        <div class="form-group">
                            <label for="username">Plan Title:</label>
                            <input type="text" class="form-control" id="plan_title" name="pcw_title"  value="<?php echo $row->pcw_title?>" >
                        </div>
                        <div class="form-group">
                            <label for="username">File:</label>
                            <input type="file" class="form-control" id="plan_file" accept="application/pdf" name="pcw_file" accept="">
                        </div>
                        <?php
                            }
                        ?>
