                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="retro1 retroshadow">Add Employee</h1>
                        </div>
                        <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-10 col-md-6">
                            <div class="card o-hidden border-0 shadow-lg my-5">
                                <div class="card-body " data-aos="slide-up">
                                <form method="post"  action="<?php echo base_url();?>User/submitemp" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="username">Name:</label>
                            <input type="text" class="form-control" id="adminname" name="name"  placeholder="Enter Name" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="adminname" name="email"  placeholder="Enter Email" required>
                            <span class="text-danger fontColor"><?php echo form_error('catname'); ?></span>
                        </div>
                        <div class="form-group">
                            <label for="username">Position:</label>
                            <input type="text" class="form-control" id="adminname" name="position"  placeholder="Enter Email" required>
                            <span class="text-danger fontColor"><?php echo form_error('catname'); ?></span>
                        </div>
                        <div class="form-group">
                            <label for="username">Image:</label>
                            <input type="file" class="form-control" id="event_image" name="image" accept="image/*" required>
                        </div>
