		...
		<div class="container fadeInDown">
			<div class="row main">
			 ...
			 border-width: 1px;border-color: #543884; box-shadow: 0px 0px 20px #E805F4;">
					<form class="form-horizontal" method="post" action="<?php echo base_url();?>User/delete_data">
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="id" id="id"  placeholder="Enter the ID you want to delete"/>
								</div>
								<span class="text-danger fontColor"><?php echo form_error('id'); ?></span>
							</div>
                        </div>
						<div class="form-group ">
                            <input type="submit"  class="btn btn-primary btn-lg btn-block login-button" style="font-family:Courier New;background:#A40E57;" name="submit">
						</div>
					</form>
				</div>
			</div>
