                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="retro1 retroshadow">Edit Employee</h1>
                        </div>
                        ...
                        <form method="POST" action="<?php echo base_url();?>User/updateemployee" enctype="multipart/form-data" class="user">
                        <input type ="hidden" name = "edit_id" value = "<?php  echo $row->ID;?>">
                        <div class="form-group">
                            <label for="username">Name:</label>
                            <input type="text" class="form-control" id="adminname" name="name"  placeholder="Enter Name"  value="<?php echo $row->name?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="adminname" name="email"  placeholder="Enter Email"  value="<?php echo $row->email?>">
                            <span class="text-danger fontColor"><?php echo form_error('catname'); ?></span>
                        </div>
                        <div class="form-group">
                            <label for="username">Position:</label>
                            <input type="text" class="form-control" id="adminname" name="position"  placeholder="Enter Position"  value="<?php echo $row->position?>">
                            <span class="text-danger fontColor"><?php echo form_error('catname'); ?></span>
                        </div>
                        <div class="form-group">
