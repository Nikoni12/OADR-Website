            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <form method="POST" action="<?php echo base_url();?>User/submitgadact" enctype="multipart/form-data" class="user">
                        <div class="form-group">
                            <label for="username">Activity Title:</label>
                            <input type="text" class="form-control" id="plan_title" name="act_title"  placeholder="Enter File Title" required>
                        </div>
                        <div class="form-group">
                            <label for="username">Overview:</label>
                            <input type="text" class="form-control" id="plan_title" name="act_overview"  placeholder="Enter File Title" required>
                        </div>
                        <div class="form-group">
                            <label for="username">Image (JPG/PNG only):</label>
