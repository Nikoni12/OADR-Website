            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <form method="POST" action="<?php echo base_url();?>User/updategadpublication" enctype="multipart/form-data" class="user">
                        <input type ="hidden" name = "edit_id" value = "<?php  echo $row->ID;?>">
                        <div class="form-group">
                            <label for="username">Report Title:</label>
                            <input type="text" class="form-control" id="report_title" name="pub_title"  value="<?php echo $row->pub_title?>" >
                        </div>
                        <div class="form-group">
                            <label for="username">File:</label>
                            <input type="file" class="form-control" id="report_file" name="pub_file" accept="">
                        </div>
                        <?php
                            }
                        ?>
