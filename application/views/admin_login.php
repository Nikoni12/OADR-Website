		...
		<div class="container fadeInDown">
			<div class="row main">
			 ...
			 border-width: 1px;border-color: #543884; box-shadow: 0px 0px 20px #E805F4;">
                    <form method="post"  action="<?php echo base_url();?>User/login_admin">
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="adminName" id="adminName"  placeholder="Enter your Username"/>
                                </div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="password" class="form-control" name="adminPass" id="adminPass"  placeholder="Enter your Password"/>
								</div>
                                <span class="text-danger fontColor"><?php echo form_error('adminPass'); ?></span>
							</div>
						</div>
                        <div class="form-group ">
							<input type="submit" class="btn btn-primary btn-lg btn-block login-button" style="font-family:Courier New;background:#A40E57;" name = "login" value = "LOGIN"/>
						</div>
					</form>
				</div>
			</div>
