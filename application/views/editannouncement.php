                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="retro1 retroshadow">Edit Announcement</h1>
                        </div>
                        ...
                        ?>
                        <form method="POST" action="<?php echo base_url();?>User/updateannouncement" enctype="multipart/form-data" class="user">
                        <input type ="hidden" name = "edit_id" value = "<?php  echo $row->ID;?>">
                        <div class="form-group">
                            <label for="username">Title:</label>
                            <input type="text" class="form-control" id="announcement_title" name="announcement_title"  placeholder="<?php echo $row->announcement_title?>" required>
                        </div>
                        <div class="form-group">
                            <label for="username">Content:</label>
                            <textarea class="form-control" id="announcement_content" name="announcement_content" rows="3" placeholder="<?php echo $row->announcement_content?>" ></textarea>
                        </div>
                        <div class="form-group">
