                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="retro1 retroshadow">Add T.P.D Development</h1>
                        </div>
                        <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-10 col-md-6">
                            <div class="card o-hidden border-0 shadow-lg my-5">
                                <div class="card-body " data-aos="slide-up"><br><br>
                        <form method="POST" action="<?php echo base_url();?>User/submittraining" enctype="multipart/form-data" class="user">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="event_content" name="description" rows="3"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="id_start_datetime">Start Date</label>
                            <div class="input-group date" id="id_3">
                                <input type="text" id="picker1" name="start_date" value="" class="form-control" required/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="id_4">
                                <input type="text" id="picker2" name="end_date" value="" class="form-control" required/>
                                <div class="input-group-addon input-group-append">
                                    <div class="input-group-text">
                                        <i class="glyphicon glyphicon-calendar fa fa-calendar"></i>
                                    </div>
