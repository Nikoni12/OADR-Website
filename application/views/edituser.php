...
<html lang="en">
    ...
    <?php $this->session->unset_userdata('invalid');} else if($this->session->userdata('oldpass')){?>
        <script>
		Swal.fire({
					title: 'Wrong Password',
					text: "Your old password does not match to your current password.",
					icon: 'error',
					iconColor: 'gold',
					confirmButtonColor: 'gold'
				})
		</script>
    <?php $this->session->unset_userdata('oldpass');} ?>
</html>