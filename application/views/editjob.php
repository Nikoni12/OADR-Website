                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="retro1 retroshadow">Edit Job</h1>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-10 col-md-6">
                            ...
                            <input type="text" class="form-control" id="adminname" name="position_title"  placeholder="Enter Position Title" value="<?php echo $row->position_title?>">
                            <span class="text-danger fontColor"><?php echo form_error('catname'); ?></span>
                        </div>
                        <div class="form-group">
                            <label for="username">Plantilla Item No.:</label>
                            <input type="text" class="form-control" id="adminname" name="plantilla"  placeholder="Enter Plantilla Item No." value="<?php echo $row->plantilla?>">
                            <span class="text-danger fontColor"><?php echo form_error('catname'); ?></span>
                        </div>
                        <div class="form-group">
                            <label for="username">Salary / Job / Pay Grade: </label>
                            <input type="text" class="form-control" id="adminname" name="paygrade"  placeholder="Enter Salary / Job / Pay Grade" value="<?php echo $row->paygrade?>">
                            <span class="text-danger fontColor"><?php echo form_error('catname'); ?></span>
                        </div>
                        <div class="form-group">
                            <label for="username">Monthly Salary: </label>
                            <input type="text" class="form-control" id="adminname" name="salary"  placeholder="Enter Monthly Salary" value="<?php echo $row->salary?>">
                            <span class="text-danger fontColor"><?php echo form_error('catname'); ?></span>
                        </div>
                        <div class="form-group">
                            <label for="username">Education: </label>
                            <input type="text" class="form-control" id="adminname" name="education"  placeholder="Enter Education:" value="<?php echo $row->education?>">
                            <span class="text-danger fontColor"><?php echo form_error('catname'); ?></span>
                        </div>
                        <div class="form-group">
                            <label for="username">Training: </label>
                            <input type="text" class="form-control" id="adminname" name="training"  placeholder="Enter Training:" value="<?php echo $row->training?>">
                            <span class="text-danger fontColor"><?php echo form_error('catname'); ?></span>
                        </div>
                        <div class="form-group">
                            <label for="username">Experience: </label>
                            <input type="text" class="form-control" id="adminname" name="experience"  placeholder="Enter Experience" value="<?php echo $row->experience?>">
                            <span class="text-danger fontColor"><?php echo form_error('catname'); ?></span>
                        </div>
                        <div class="form-group">
                            <label for="username">Eligibility:</label>
                            <input type="text" class="form-control" id="adminname" name="eligibility"  placeholder="Enter Eligibility" value="<?php echo $row->eligibility?>">
                            <span class="text-danger fontColor"><?php echo form_error('catname'); ?></span>
                        </div>
                        <div class="form-group">
                            <label for="username">Competency:</label>
                            <input type="text" class="form-control" id="adminname" name="competency"  placeholder="Enter Competency" value="<?php echo $row->competency?>">
                            <span class="text-danger fontColor"><?php echo form_error('catname'); ?></span>
                        </div>
                        <div class="form-group">
                            <label for="username">Place of Assignment: </label>
                            <input type="text" class="form-control" id="adminname" name="place"  placeholder="Enter Place of Assignment" value="<?php echo $row->place?>">
                            <span class="text-danger fontColor"><?php echo form_error('catname'); ?></span>
                        </div>
