            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <form method="POST" action="<?php echo base_url();?>User/submitgadavm" enctype="multipart/form-data" class="user">
                        <div class="form-group">
                            <label for="username">AVM Title:</label>
                            <input type="text" class="form-control" id="report_title" name="vid_title"  placeholder="Enter File Title" required>
                        </div>
                        <div class="form-group">
                            <label for="username">AVM Link:</label>
                            <input type="text" class="form-control" id="report_title" name="vid_link"  placeholder="Enter File Title" required>
                        </div>
